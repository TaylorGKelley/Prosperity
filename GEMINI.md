...
- **GraphQL Schema:** Automatically generated at `apps/api/src/lib/graphhql/schema/schema.gql`.
...
- **Authentication:** Always use the session context from `Better-Auth` to authorize requests.
